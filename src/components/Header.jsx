    ...
    <div className="lg:container md:w-full flex px-10 justify-between items-center">
        <li  className='list-none cursor-pointer'>
          ...
          <nav className='flex justify-start items-center gap-x-20 md:gap-x-10'>
            <li onClick={(e)=> onClick(e)} linkto='hero' className='uppercase font-bold active cursor-pointer tracking-wider text-white list-none' >Home</li>
            ...
            <li onClick={(e)=> onClick(e)} linkto='team' className='uppercase cursor-pointer tracking-wider text-white list-none'>team</li>
