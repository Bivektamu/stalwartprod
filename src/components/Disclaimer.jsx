...
const Disclaimer = () => {
  return (
    <div id="disclaimer" className="lg:container m-auto md:px-10 pt-10">
      ...
      <h3 className="mb-4">Ownership of Images and Videos</h3>
      <p className="mb-8">
      ...
      <h3 className="mb-4">Copyright and Reproduction</h3>
      <p className="mb-8">
      ...
      <h3 className="mb-4">Client Cooperation</h3>
      <p className="mb-8">
      ...
      <h3 className="mb-4">Liability</h3>
      <p className="mb-8">
      ...
      <h3 className="mb-4">Payment and Cancellation</h3>
      <p className="mb-8">
      ...
      <h3 className="mb-4">Editing and Delivery</h3>
      <p className="mb-8">
      ...
      <h3 className="mb-4">Force Majeure</h3>
      <p className="mb-8">
      ...
      <h3 className="mb-4">Governing Law</h3>
      <p className="mb-8">
