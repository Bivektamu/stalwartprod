  ...
  return (
    <section id="work">
      <div className="lg:container m-auto py-20 md:py-40 px-4 md:px-10 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3  gap-y-10 lg:gap-8 ">
      ...
      {show && (
        <div id="popup-library" className='fixed top-0 z-30 left-0 w-full h-full bg-black/[.4] flex items-center justify-center px-10 py-20'>
